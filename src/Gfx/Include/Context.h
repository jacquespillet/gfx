...
struct context
{
    ...
    void UpdateTLAccelerationStructure(accelerationStructureHandle AS, std::vector<glm::mat4> &Transforms, std::vector<accelerationStructureHandle> &AccelerationStructures, std::vector<int> Instances);
