...
#if GRAPHICS_API==VK
#define DECLARE_UNIFORM_TEXTURE_UINT(Set, Binding, Name) layout(set = Set, binding = Binding) uniform usampler2D Name
#elif GRAPHICS_API==GL
#define DECLARE_UNIFORM_TEXTURE_UINT(Set, Binding, Name) layout(binding = Binding) uniform usampler2D Name;
#endif

#if GRAPHICS_API==VK
#define DECLARE_UNIFORM_TEXTURE_ARRAY(Set, Binding, Name) layout(set = Set, binding = Binding) uniform sampler2DArray Name
#elif GRAPHICS_API==GL
#define DECLARE_UNIFORM_TEXTURE_ARRAY(Set, Binding, Name) layout(binding = Binding) uniform sampler2DArray Name;
#endif
